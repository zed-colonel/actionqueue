...
fn write_framed_snapshot(path: &std::path::Path, _version: u32, snapshot: &Snapshot) {
    let envelope = serde_json::json!({
        "store_id": uuid::Uuid::nil(), "snapshot_schema": 2, "projection_version": 2,
        "wal_sequence": snapshot.metadata.wal_sequence,
        "digest": {"algorithm":"sha256", "version":2,"hex":"unused for invalid schema"},
        "reserved": {"signals":[],"waits":[],"checkpoints":[],"resume_assignments":[],"causal_control":[]},
        "projection":snapshot
    });
...
fn d06_t_n2_loader_rejects_snapshot_payload_that_fails_mapping_invariants() {
    ...
    let envelope = serde_json::json!({
        "store_id": uuid::Uuid::nil(), "snapshot_schema": 2, "projection_version": 2,
        "wal_sequence": 2,
        "digest": {"algorithm":"sha256", "version":2,"hex":"domain validation must fail first"},
        "reserved": {"signals":[],"waits":[],"checkpoints":[],"resume_assignments":[],"causal_control":[]},
