...
# The retained projection image is the single current known-answer vector; its
# digest is recomputed independently of the Rust implementation.
p = json.loads((root/'projection-v9-vector.json').read_text())['projection']
assert p['version'] == p['metadata']['schema_version'] == 9
